public class Animal { // create the animal class and make it public so it can be used in other files
    ...
    public Animal(String name, String colour, int age, String favFood) {
        this.name = name; // use this. since professor said its important to know the exact variable being
                          // used
        this.colour = colour; // this variable colour is the same one being used in the zoo class so this. is
                              // needed
        this.age = age;
    ...
    public String getName() { // create the getters for the animal class to run with the zoo class. this file
        ...
        return name; // get the name (data) inputted and return it to the zoo class.
    }

    public String getColour() { // same as above, get the colour (data) inputted and return it to the zoo class
        return colour;
    }
