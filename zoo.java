...
public class Zoo { // create the class zoo
    public static void main(String[] args) { // starting the code with the same method taught in past lessons
        ...
        System.out.print("Enter animal colour: "); // Copy the same code above but change the prompt to ask the user
        String colour = scanner.nextLine(); // same code as above again, now the string name is changed to colour, NOT
                                            // name
        ...
        Animal animal = new Animal(name, colour, age, favFood); // creates a new animal object using the variables name,
                                                                // colour, age, and favFood
